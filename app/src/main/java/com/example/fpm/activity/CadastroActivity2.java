...
import static com.example.fpm.activity.CadastroActivity.ender;
...
public class CadastroActivity2 extends AppCompatActivity {
    ...
    public void starttela2Activity2(View view) {
        ...
        if (verificarCampos(v) == true) {
            if(verificarSenhas(v)==true){
                ...
                cadastrarClasse();
                auth.createUserWithEmailAndPassword(usuario.getEmail(), usuario.getSenha()).addOnCompleteListener(CadastroActivity2.this, new OnCompleteListener<AuthResult>() {
                    @Override
                                ...
                                if(u==true){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(CadastroActivity2.this, "Erro ao fazer upload da imagem", Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        @Override
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            Toast.makeText(CadastroActivity2.this, "Sucesso ao fazer upload da imagem", Toast.LENGTH_SHORT).show();
                                        }
                                    });
    ...
    public void cadastrarClasse () {
        ...
        usuario.setEndereco(ender.getText().toString());
    }
}
